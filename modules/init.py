...
def cmd_init():
    """First-time setup for pair."""
    if CONFIG_FILE.exists():
        print("config.yaml already exists.")
        print("Use 'pair generate' to regenerate journals.")
        return

    print("pair — First Time Setup\n")
    ...
    if not journal_path.exists():
        ...
        with open(journal_path, 'w') as f:
            ...
            f.write(f"; Created by: pair init\n\n")
    ...
    print(f"\n  You're ready. Try 'pair asset add' or 'pair worth'.")


def _default_accounts(bank_account, currency):
    """Generate default accounts.journal content."""
    return """; pair account declarations
; Generated by: pair init
