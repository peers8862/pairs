# hledger-company — Design Reference
...
## Relevance to hledger-company

This matrix defines the complete set of accounting relationships. Every command in hledger-company that generates a journal entry maps to one of these pairs:

| hledger-company module | Primary pairs used |
|---|---|
